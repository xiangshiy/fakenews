import os
import vggish_src.vggish_input as vggish_input
import numpy as np
import torch
import torch.nn as nn
from vggish_src.vggish_params import (EMBEDDING_SIZE,
...
def vggish(pretrained=False, **kwargs):
    model = VGGish(**kwargs)
    if pretrained:
        model.load_state_dict(torch.load('vggish.pth'))
    return model
